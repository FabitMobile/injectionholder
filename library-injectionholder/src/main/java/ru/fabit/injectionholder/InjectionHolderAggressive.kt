...
class InjectionHolderAggressive private constructor(lifecycleCallbacksRegistry: LifecycleCallbacksRegistry) {

    companion object {
        @JvmStatic
        val instance by lazy {
            InjectionHolderAggressive(
                LifecycleCallbackRegistryImpl(
                    ComponentCreationMode.AGGRESSIVE
                )
            )
        }
